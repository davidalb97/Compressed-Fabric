...
############IMAGE SECTION#################
compressed_i = Image.open("compressed_image_layers/compressed_i.png").convert('RGBA')
compressed_ii = Image.open("compressed_image_layers/compressed_ii.png").convert('RGBA')
compressed_iii = Image.open("compressed_image_layers/compressed_iii.png").convert('RGBA')
compressed_iv = Image.open("compressed_image_layers/compressed_iv.png").convert('RGBA')

def sideTexture():
    try:
        blockTexture = Image.open("block/"+blockName + ".png").convert('RGBA')
        ...
        try:
            blockTexture = Image.open("block/"+blockName + "_side.png").convert('RGBA')
            Image.alpha_composite(blockTexture, compressed_i).save(imagePath+""+blockName+"_i.png")
            Image.alpha_composite(blockTexture, compressed_ii).save(imagePath+""+blockName+"_ii.png")
            Image.alpha_composite(blockTexture, compressed_iii).save(imagePath+""+blockName+"_iii.png")
            Image.alpha_composite(blockTexture, compressed_iv).save(imagePath+""+blockName+"_iv.png")
        except Exception as e:
            print("Error: unable to find a texture named " + blockName + "  Error: " + e)
            quit()

def topTexture():
    try:
        blockTextureTop = Image.open("block/" + blockName + "_top.png").convert('RGBA')
...
def bottomTexture():
    try:
        blockTextureBottom = Image.open("block/"+ blockName + "_bottom.png").convert('RGBA')
        Image.alpha_composite(blockTextureBottom, compressed_i).save(imagePath+""+blockName+"_bottom_i.png")
        Image.alpha_composite(blockTextureBottom, compressed_ii).save(imagePath+""+blockName+"_bottom_ii.png")
        Image.alpha_composite(blockTextureBottom, compressed_iii).save(imagePath+""+blockName+"_bottom_iii.png")
        Image.alpha_composite(blockTextureBottom, compressed_iv).save(imagePath+""+blockName+"_bottom_iv.png")
    except Exception as e:
        print(e + "Error: unable to find a texture named " + blockName + "_bottom.png")
        quit()
